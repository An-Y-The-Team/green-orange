...
// Degrades to [] on 501 only (the Python teaching backend's unimplemented
// endpoints) — every other failure rethrows to error.tsx, so an outage cannot
// render as "no records". See apiFetchSafe in utils/http/http.ts.
