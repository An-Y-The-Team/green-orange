...
export default async function CrewPage() {
  const [workingCount, roles, projects, crew, pending, openShifts] =
    await Promise.all([
      ...
      getPendingTimekeeping(),
      // Shifts clocked in and not out. Nothing sweeps these, so the operator only
      // learns about an abandoned one by seeing it here.
      getOpenShifts(),
    ]);
