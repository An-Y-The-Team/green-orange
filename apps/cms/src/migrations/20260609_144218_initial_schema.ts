...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_services_category" AS ENUM('cleaning', 'construction');
  CREATE TYPE "public"."enum_projects_category" AS ENUM('cleaning', 'construction');
  CREATE TYPE "public"."enum_testimonials_category" AS ENUM('cleaning', 'construction', 'both');
  CREATE TYPE "public"."enum_contact_submissions_service_category" AS ENUM('cleaning', 'construction', 'both');
  CREATE TYPE "public"."enum_contact_submissions_status" AS ENUM('new', 'processing', 'contacted');
  ...
  CREATE TABLE "projects" (
  	...
  	"testimonial_avatar_url" varchar,
  ...
  CREATE TABLE "testimonials" (
  	...
  	"category" "enum_testimonials_category" NOT NULL,
  	"order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "contact_submissions" (
  	...
  	"service_category" "enum_contact_submissions_service_category" NOT NULL,
  	"service_id" varchar,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_contact_submissions_service_category";
